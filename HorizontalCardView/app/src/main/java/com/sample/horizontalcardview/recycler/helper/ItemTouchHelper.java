...
package com.sample.horizontalcardview.recycler.helper;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    boolean mMoveLock = false;
    Object mMoveLockObject = new Object();
    Runnable lockrelease = new Runnable() {
        @Override
        public void run() {
            synchronized (mMoveLockObject) {
                mMoveLock = false;
            }
        }
    };
     ...
     */
    private synchronized void moveIfNecessary(ViewHolder viewHolder) {
        ...
        mRecyclerView.removeCallbacks(lockrelease);
        mRecyclerView.postDelayed(lockrelease,500);
    }
    ...
    public abstract static class Callback {
        ...
        public ViewHolder chooseDropTarget(ViewHolder selected,
            ...
            for (int i = 0; i < targetsSize; i++) {
                ...
                if (dx > 0) {
                    int diff = (target.itemView.getRight() / 2) - right;
